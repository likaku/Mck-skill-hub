...
│                                                             │
│   ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐     │
│   │ PPT 设计  │ │ 演讲写作  │ │ HTML 演示 │ │ 成本分析  │     │
│   │    ✅     │ │    ✅     │ │    ✅     │ │   🧪     │     │
│   └──────────┘ └──────────┘ └──────────┘ └──────────┘     │
│   ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐     │
│   │ 市场调研  │ │ 竞品分析  │ │ 商业计划  │ │ 数据可视化 │     │
│   │   🔜     │ │   🔜     │ │   🔜     │ │   🔜     │     │
│   └──────────┘ └──────────┘ └──────────┘ └──────────┘     │
│   ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐     │
│   │ 邮件写作  │ │ 会议纪要  │ │ 项目管理  │ │ 财务建模  │     │
...
│   └──────────┘ └──────────┘ └──────────┘ └──────────┘     │
│                                                             │
│   每一个 Skill = 一块能力拼图    所有拼图 = 一个完整的数字员工  │
└─────────────────────────────────────────────────────────────┘
```
...
| 📊 **数据可视化** | 图表设计、Dashboard、数据叙事 | `🔜 计划中` |
| ✉️ **邮件写作** | 商务邮件、客户沟通、跟进模板 | `🔜 计划中` |
| 📝 **会议纪要** | 自动记录、行动项提取、决策追踪 | `🔜 计划中` |
| 🗂️ **项目管理** | 进度跟踪、风险管理、资源协调 | `🔜 计划中` |
| 💰 **财务建模** | DCF、敏感性分析、估值模型 | `🔜 计划中` |

**每造一个 Skill，数字知识工作者就多一项能力。** 来造第一个属于你的：[贡献指南 →](CONTRIBUTING.md)
...
- [x] 核心能力模块上线（PPT 设计、演讲设计、HTML 设计）
- [ ] 分析类 Skill（成本分析、市场调研、竞品分析）
- [ ] Skill 链 — 将多个 Skill 组合成端到端工作流
- [ ] Skill 市场 — 发现和分享社区 Skill
- [ ] **完整数字知识工作者 v1.0** — 所有核心能力模块就位
